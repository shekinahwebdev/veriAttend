"use client";
import { CheckCircle2, ArrowRight, LogIn, UserPlus } from "lucide-react";
...
export default function CompleteScreen() {
  return (
    <div className="flex flex-col justify-center items-center animate-fade-in-stagger max-w-md mx-auto lg:max-w-none">
      <div className="w-16 h-16 rounded-full animate-icon-pop bg-primary/10 dark:bg-primary/15 text-primary flex items-center justify-center border border-primary/20 mb-2">
