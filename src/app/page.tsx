...
import { OrbitLogo } from "@/components/onboarding/orbit-logo";
...
import RoleQuestions from "@/components/onboarding/role-questions/page";
import { UserRole } from "@/features/onboarding/questions";
import CompleteScreen from "@/components/onboarding/complete-screen/page";
        ...
        {flowStep === "role-select" && (
          <div className="flex flex-col justify-center animate-fade-in-stagger">
            ...
            <p className="mt-3 text-muted-foreground text-base max-w-md">
              Select your primary workspace ecosystem. We will configure your
              verification credentials based on this role.
            </p>

            <div className="mt-10 p-1.5 bg-muted/50 dark:bg-slate-900/90 border border-border/80 dark:border-slate-800/60 rounded-2xl relative flex flex-col md:flex-row w-full gap-1 shadow-inner">
              <div
              ...
              {roles.map((role, idx) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`p-2.5 rounded-lg border transition-all mb-3 ${
                        isSelected
            ...
            <div className="mt-10 flex items-center justify-center border-t border-border/60 dark:border-slate-800/60 pt-6">
              <button
                type="button"
